...
public:
    void set_host(const std::string &tmp);
    ...
    void start(const controller::CRBModule &crb, const std::string &execname, const std::string &category, const std::string &key,
               const std::string &name, const std::string &instanz, const std::string &host);
...
public:
    ...
    void delete_mod(const std::string &name, const std::string &nr, const std::string &host);

    void set_new_status();

    modui *get(int nodeid);
    modui *get(const std::string &key);
    modui *get(const std::string &name, const std::string &nr, const std::string &host);
};
